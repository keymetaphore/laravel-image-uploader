...
return [
    ...
    */
    ...
    'before_or_equal' => ':attribute datumam ir jābūt pirms vai vienādam ar :date.',
    'between'         => [
        ...
        'array'   => ':attribute ir jābūt starp :min un :max lietām.',
    ],
    'boolean'        => ':attribute ir jābūt patiesam vai nepatiesam.',
    'confirmed'      => ':attribute apstiprināšana nesakrīt.',
    'date'           => ':attribute nav derīgs datums.',
    'date_equals'    => ':attribute datumam ir jābūt vienādam ar :date.',
    ...
    'gte' => [
        'numeric' => ':attribute ir jābūt lielākam vai vienādam ar :value.',
        'file'    => ':attribute ir jābūt lielākam vai vienādam ar :value kilobaitiem.',
        'string'  => ':attribute ir jābūt lielākam vai vienādam ar :value rakstzīmēm.',
        'array'   => ':attribute ir jābūt :value lietām vai vairāk.',
    ],
